        ...
        <div className="cf">
          ...
          <nav className="w-100 mv3">
            ...
            <div className="v-mid tr pv3 mr3 fr">
              ...
              <Link to={'/dashboard'} className="f6 fw4 hover-white no-underline white-90 dib pv2 ph3 br1 grow link ba" >Dashboard</Link>
              <a className="f6 fw4 hover-white no-underline white-90 dib pv2 ph3 br1 grow link" href="/" onClick={this.logout}>Log out</a>
