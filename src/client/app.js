      ...
      <div>
        ...
        <main>
          ...
          <div className="mv5 mh6">
            ...
            <ul>
              <li><a href="#" className="link dark-gray">Some study</a></li>
              <li><a href="#" className="link dark-gray">Another study</a></li>
            </ul>
        ...
        <footer>
          <div className="footer cf w-100 center">
            ...
            <div className="fl w-25 pa2  ">
              <p className="white-90">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <div className="fl w-25 pa2  ">
              <p className="white-90">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
        ...
        >
          ...
          {this.state.login ? <Login saveUser={this.saveUser} />  : <Signup saveUser={this.saveUser} />}
